...
import static com.github.casperjs.casperjsrunner.toolchain.CasperjsToolchain.KEY_CASPERJS_EXECUTABLE;
...
public class DefaultCasperjsToolchainFactory implements ToolchainFactory {
    ...
    public ToolchainPrivate createToolchain(final ToolchainModel model) throws MisconfiguredToolchainException {
        ...
        if (casperjsExecutable == null) {
            throw new MisconfiguredToolchainException("CasperJS toolchain without the " + KEY_CASPERJS_EXECUTABLE + " configuration element.");
        }
