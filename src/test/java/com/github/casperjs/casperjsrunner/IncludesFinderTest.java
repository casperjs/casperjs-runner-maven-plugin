...
public class IncludesFinderTest {
    ...
    public void testFindScript() {
        assertEquals(newHashSet("1.inc.js", "inc.js", "test.js"), newHashSet(new IncludesFinder(TEMP_DIR, asList("*.*")).findIncludes()));
    }

    @Test
    public void testFindScriptWithPatterns() {
        assertEquals(newHashSet("1.inc.js"), newHashSet(new IncludesFinder(TEMP_DIR, asList("*.inc.js")).findIncludes()));
        assertEquals(newHashSet("1.inc.js", "inc.js"), newHashSet(new IncludesFinder(TEMP_DIR, asList("*inc.js")).findIncludes()));
    }
}
