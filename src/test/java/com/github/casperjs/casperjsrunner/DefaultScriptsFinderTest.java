...
public class DefaultScriptsFinderTest {
    ...
    public static void deleteScripts() {
        for (final File f : new File(TEMP_DIR, "subdir").listFiles()) {
            f.delete();
        }
        for (final File f : TEMP_DIR.listFiles()) {
            f.delete();
        }
        TEMP_DIR.delete();
    }
    ...
    public void testFindScript() {
        assertEquals(newHashSet("test1.js", "testNot1.js", "test1.coffee", "testnot1.coffee", "testSuite2.js", "testSuite2.coffee"),
    ...
    public void testFindScriptWithIncludesAndExcludes() {
        assertEquals(newHashSet("test1.js", "testSuite2.js"),
                newHashSet(new DefaultScriptsFinder(TEMP_DIR, null, asList("*.js"), asList("*not*")).findScripts()));
        assertEquals(newHashSet("test1.coffee", "testSuite2.coffee"),
